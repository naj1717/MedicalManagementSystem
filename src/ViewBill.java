...
public class ViewBill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 14, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bill ID", "Patient Name", "Patient Mob No.", "Date", "Total Paid", "Generated By"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 830, 422));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try
        {
            ...
            while(rs.next())
            {
                model.addRow(new Object[]{rs.getString("billId"),rs.getString("patientName"),rs.getString("mobNumber"),rs.getString("billDate"),rs.getString("totalPaid"),rs.getString("generatedBy"
                )});
            }
        }
        catch(Exception e)
